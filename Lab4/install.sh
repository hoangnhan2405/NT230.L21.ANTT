...
cd /home/huydoan && mkdir deps && cd deps
...
for d in */
do
        cd /home/huydoan/deps/"$d" && python setup.py install
done

# Ubuntu 16.04 sometimes dont recognize impacket module, can install use: pip install impacket